...
import prof from "./front.png";

function WhiteBox4() {
  return (
    <div style={{ backgroundColor: 'white', height: '20vh', width: '100%' }}>
...
function TutorInfo() {
  ...
  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginLeft: "9%" }}>
    <h3 style={{ fontFamily: 'Roboto', textAlign: 'left' }}>
      Στο MyStudies με τη σύνδεση σας έχετε τη δυνατότητα να καταθέσετε βαθμολογίες για τα ενεργά μαθήματα σας, να προβάλλετε συγκεντρωτικά όλα τα βαθμολόγια σας καθώς και να διαχειριστείτε τις πληροφορίες των μαθημάτων που διδάσκετε.
    </h3>
    ...
    <h4 style={{whiteSpace: 'nowrap', fontFamily: 'Roboto'}}>Οδηγός χρήσης mystudies για καθηγητές</h4>
</a>
