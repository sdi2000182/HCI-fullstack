...
const Enrol = ({isWinter}) => {
  ...
  const handleCheckboxChange = (id, category) => {
    setCheckedItems((prevCheckedItems) => ({
      ...prevCheckedItems,
      [`${category}-${id}`]: !prevCheckedItems[`${category}-${id}`],
    }));
  };
...
const YourCardComponent = ({ subj, reference, isChecked,onCheckboxChange,checkedCount }) => {
  
    return (
      <Card sx={{ ...cardStylessubj, left: 100, width: 720 }}>
        {checkedCount+1 <= 8|| isChecked ? (
          <Checkbox
            checked={isChecked}
  ...
  const shouldShowCard = (index,str) => {
    ...
    if (index <= 8) {
      ...
      if (index <= 7) {
        ...
        if ((filter[9] && index % 2 == 0) || (isWinter==1 && index%2 == 0)) {
          return true;
        }
  ...
  const handleNext = (checkedCount) => {
    
    console.log('Button clicked! Perform your action here.');
  ...
  <Divider aria-hidden="true" style={{ marginTop: "0", marginLeft: "2%", marginBottom: "20px", width: "42vw" ,alignSelf: 'flex-start'}} />
          ...
          >
            ...
            {isButtonVisible && (
        <Button onClick={() => handleNext(Object.values(checkedItems).filter((isChecked) => isChecked).length)} style={tempBoxStyles}>
                ...
                <div key={index} style={{ marginBottom: "10px", zIndex: 9 }}>
                  ...
                  {clickedIndices.includes(index) && (
                    <>
                          ...
                          >
                            {Array.isArray(backendResponse[index]) ? (
                              ...
                              backendResponse[index].map((classInfo, index) => (
                                                <YourCardComponent
                                key={`second-${classInfo.Class_ID}`}
                                subj={classInfo}
                                reference={eidikRef}
                                isChecked={checkedItems[`second-${classInfo.Class_ID}`]}
                                onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "second")}
                                checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}
                            />
                              ))
                            ) : (
                              <p></p>
                            ...
                            {Array.isArray(backendResponse1[index]) ? (
                              ...
                              backendResponse1[index].map(
                                (classInfo, index) => (
                                    ...
                                    subj={classInfo}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`third-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "third")}
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}
                                />
                                )
                              )
                            ...
                            {Array.isArray(backendResponse3[0][index]) ? (
                              ...
                              backendResponse3[0][index].map(
                                (classInfo, index) => (
                                  ...
                                  key={`fifth-${index}`}
                                  reference={eidikRef}
                                  isChecked={checkedItems[`fifth-${classInfo.Class_ID}`]}
                                  onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "fifth")}
                                  checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}  />
                                )
                              )
                            ) : (
                            ...
                            {Array.isArray(backendResponse2[0][index]) ? (
                              ...
                              backendResponse2[0][index].map(
                                (classInfo, index) => (
                                    ...
                                    key={`sixth-${index}`}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`sixth-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "sixth")}
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}  />
                                )
                              )
                            ) : (
                            ...
                            {Array.isArray(backendResponse2[1][index]) ? (
                              ...
                              backendResponse2[1][index].map(
                                (classInfo, index) => (
                                    ...
                                    key={`seventh-${index}`}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`seventh-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "seventh")}
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}  />
                            ...
                            {Array.isArray(backendResponse2[2][index]) ? (
                              ...
                              backendResponse2[2][index].map(
                                (classInfo, index) => (
                                    ...
                                    key={`eight-${index}`}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`eight-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "eight")}
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}  />
                                )
                              )
                            ) : (
                          ...
                          >
                            {Array.isArray(backendResponse8[0][index]) ? (
                              ...
                              backendResponse8[0][index].length > 1 ? (
                                <YourCardComponent subj={backendResponse8[0][index][1]}
                                key={`nine-${index}`}
                                reference={eidikRef}
                                isChecked={checkedItems[`nine-${backendResponse8[0][index][1]}`]}
                                onCheckboxChange={() => handleCheckboxChange(backendResponse8[0][index][1], "nine")} 
                                checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length} />
                              ) : (
                                <p></p>
                              )
                            ...
                            {Array.isArray(backendResponse3[1][index]) ? (
                              ...
                              backendResponse3[1][index].map(
                                (classInfo, index) => (
                                    ...
                                    key={`eleven-${index}`}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`eleven-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "eleven")}
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}  />
                                )
                              )
                            ) : (
                            ...
                            {Array.isArray(backendResponse2[3][index]) ? (
                              ...
                              backendResponse2[3][index].map(
                                (classInfo, index) => (
                                    ...
                                    key={`twelve-${index}`}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`twelve-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "twelve")} 
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length} />
                                )
                              )
                            ) : (
                            ...
                            {Array.isArray(backendResponse2[4][index]) ? (
                              ...
                              backendResponse2[4][index].map(
                                (classInfo, index) => (
                                    ...
                                    key={`thirteen-${index}`}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`thirteen-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "thirteen")}
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}  />
                                )
                              )
                            ) : (
                            ...
                            {Array.isArray(backendResponse2[5][index]) ? (
                              ...
                              backendResponse2[5][index].map(
                                (classInfo, index) => (
                                    ...
                                    key={`fourteen-${index}`}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`fourteen-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "fourteen")} 
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length} />
                                )
                              )
                            ) : (
                      ...
                      {prakt[index] && shouldShowCard(index,"fifteen") && (
                        <div>
                            ...
                            {Array.isArray(backendResponse8[2]) ? (
                              ...
                              backendResponse8[2][index].map(
                                (classInfo, index) => (
                                    ...
                                    key={`fifteen-${index}`}
                                    reference={eidikRef}
                                    isChecked={checkedItems[`fifteen-${classInfo.Class_ID}`]}
                                    onCheckboxChange={() => handleCheckboxChange(classInfo.Class_ID, "fifteen")}
                                    checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length}  />
                                )
                              )
                            ) : (
                      ...
                      {ptyx[index] && shouldShowCard(index,"sixteen") && (
                        <div>
                          <Card sx={{ ...cardWithRectangleStyles5 }} >
                            {" "}
                            <DescriptionIcon
                        ...
                        <div>
                          ...
                          >
                            {Array.isArray(backendResponse8[0][index]) ? (
                              backendResponse8[0][index] &&
                              backendResponse8[0][index].length > 1 ? (
                                <YourCardComponent subj={backendResponse8[0][index][0]}
                                key={`seventeenth-${index}`}
                                reference={eidikRef}
                                isChecked={checkedItems[`seventeenth-${backendResponse8[0][index][0]}`]}
                                onCheckboxChange={() => handleCheckboxChange(backendResponse8[0][index][0], "seventeenth")} 
                                checkedCount = {Object.values(checkedItems).filter((isChecked) => isChecked).length} />
                              ) : (
                                <p></p>
                              )
