...
function getCurrentSemesterNumber(registerDate) {
  ...
  if ((registrationDate.getMonth() >= 3 && registrationDate.getMonth() <= 8) ||
    ...
    semesterNumber = Math.floor(totalMonths / 6) + 2;
  } else {
    semesterNumber = Math.floor(totalMonths / 6) + 1;
  }
              ...
              {userData && (
                <>
                  <tr>
                    ...
                    <td style={{ textAlign: "left", paddingRight: "10px", borderBottom: "1px solid #ddd" ,color:"grey"}}>{`${userData.Department}`}</td>
                  </tr>
                  <tr>
                    <td style={{ textAlign: "left", paddingRight: "10px", borderBottom: "1px solid #ddd",color:"grey" }}>Εξάμηνο 1ης εγγραφής</td>
                    <td style={{ textAlign: "left", paddingRight: "10px", borderBottom: "1px solid #ddd" ,color:"grey"}}>1ο</td>
                  </tr>
                  <tr>
                    <td style={{ textAlign: "left", paddingRight: "10px", borderBottom: "1px solid #ddd" ,color:"grey"}}>Ημερομηνία 1ης εγγραφής</td>
                    <td style={{ textAlign: "left", paddingRight: "10px", borderBottom: "1px solid #ddd" ,color:"grey"}}>{formatDate(userData.Register_Date)}</td>
                  </tr>
                  <tr>
                    <td style={{ textAlign: "left", paddingRight: "10px",color:"grey"}}>Εξάμηνο Φοίτησης</td>
                    <td style={{ textAlign: "left", paddingRight: "10px",color:"grey"}}>{getCurrentSemesterNumber(userData.Register_Date)}o</td>
                  </tr>
                </>
              )}
            </tbody>
